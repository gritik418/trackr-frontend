...
export enum AuditAction {
  ...
  ORGANIZATION_INVITE_SEND = "ORGANIZATION_INVITE_SEND",
  ORGANIZATION_INVITE_REVOKE = "ORGANIZATION_INVITE_REVOKE",
  ORGANIZATION_INVITE_ACCEPT = "ORGANIZATION_INVITE_ACCEPT",
  ORGANIZATION_INVITE_REJECT = "ORGANIZATION_INVITE_REJECT",
  WORKSPACE_INVITE_SEND = "WORKSPACE_INVITE_SEND",
  WORKSPACE_INVITE_REVOKE = "WORKSPACE_INVITE_REVOKE",
  WORKSPACE_INVITE_ACCEPT = "WORKSPACE_INVITE_ACCEPT",
  WORKSPACE_INVITE_REJECT = "WORKSPACE_INVITE_REJECT",
