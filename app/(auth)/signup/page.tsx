        ...
        <div className="relative z-10 max-w-lg mt-12">
          ...
          <div className="space-y-6">
            {[
              ...
              {
                title: "Deep Insights",
                desc: "Real-time analytics for your projects.",
                icon: BarChart3,
              },
              {
                title: "Enterprise Security",
                desc: "Proper encryption and access control.",
                icon: ShieldCheck,
              },
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 bg-bg-dark-0 relative overflow-y-auto">
        <div className="w-full max-w-[400px] z-10 py-10">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            >
              ...
              >
                <div className="bg-bg-dark-2 rounded-[11px] relative h-full">
                  ...
                  />
                  <User
                    className={`absolute left-4 top-1/2 -translate-y-1/2 transition-colors ${focusedField === "name" ? "icon-active" : "icon-default"}`}
                    size={18}
                  />
                </div>
              </div>
            ...
            {/* Username */}
            <div
              className={`transition-all duration-200 ${focusedField === "username" ? "scale-[1.02]" : ""}`}
            >
              <label className="text-xs font-semibold text-neutral-500 uppercase tracking-widest ml-1 mb-2 block">
                Username
              </label>
              ...
              >
                <div className="bg-bg-dark-2 rounded-[11px] relative h-full">
                  ...
                  />
                  <span
                    className={`absolute left-4 top-1/2 -translate-y-1/2 transition-colors font-mono font-bold ${focusedField === "username" ? "icon-active" : "icon-default"}`}
                  >
                    @
                  </span>
                </div>
