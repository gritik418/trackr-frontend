            ...
            {[
              {
                ...
                desc: "Built for speed with 50ms interactions.",
                icon: Command,
              },
              {
                title: "Team Sync",
                desc: "Real-time updates with zero latency.",
                icon: Layout,
              },
              {
                title: "About Our Service",
                desc: "The complete toolkit for planning, tracking, and shipping software.",
                icon: Sparkles,
              },
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 bg-bg-dark-0 relative">
        <div className="w-full max-w-[400px] z-10">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div
              className={`transition-all duration-200 ${focusedField === "identifier" ? "scale-[1.02]" : ""}`}
            >
              ...
              >
                <div className="bg-bg-dark-2 rounded-[11px] relative h-full">
                  ...
                  />
                  <User
                    className={`absolute left-4 top-1/2 -translate-y-1/2 transition-colors ${focusedField === "identifier" ? "icon-active" : "icon-default"}`}
                    size={18}
                  />
                </div>
              </div>
