    ...
    <div className="w-full max-w-[400px] z-10">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className={`transition-all duration-200 ${focusedField === 'passwordConfirmation' ? 'scale-[1.02]' : ''}`}>
          ...
          <div className={`relative group rounded-xl transition-all duration-300 ${focusedField === 'passwordConfirmation' ? 'p-px bg-linear-to-r from-indigo-500 via-purple-500 to-indigo-500 bg-size-[200%_100%] animate-[shimmer_2s_linear_infinite]' : 'p-px bg-white/10 hover:bg-white/20'}`}>
            <div className="bg-bg-dark-2 rounded-[11px] relative h-full">
              <input
                ...
                required
              />
              <Lock className={`absolute left-4 top-1/2 -translate-y-1/2 transition-colors ${focusedField === 'passwordConfirmation' ? 'text-indigo-400' : 'text-neutral-600'}`} size={18} />
              <button
                type="button"
