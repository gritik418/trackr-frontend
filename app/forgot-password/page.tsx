  ...
  return (
    <div className="min-h-screen w-full flex bg-bg-dark-0 text-white selection:bg-indigo-500/30">
      ...
      <div className="hidden lg:flex w-1/2 relative overflow-hidden flex-col justify-between p-12 border-r border-white/5 bg-bg-dark-1">
        ...
        <div className="relative z-10 max-w-lg mt-12">
          ...
          <div className="space-y-6">
            {[
              { title: "Secure Recovery", desc: "We'll send a secure link to your registered email.", icon: Mail },
              { title: "Account Safety", desc: "Identity verification is our top priority.", icon: Sparkles }
              ...
              <div key={i} className="flex items-start gap-4 group cursor-default">
                <div className="p-3 rounded-xl bg-white/5 border border-white/5 group-hover:bg-white/10 group-hover:border-white/10 transition-colors">
                  <Icon size={20} className="text-amber-400 group-hover:text-amber-300 transition-colors" />
                </div>
                <div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 bg-bg-dark-0 relative">
        <Link href="/login" className="absolute top-8 left-8 flex items-center gap-2 text-sm text-neutral-500 hover:text-white transition-colors group">
          ...
          {!isSent ? (
            <>
              <div className="mb-8 text-center">
                <h2 className="text-3xl font-bold tracking-tighter mb-2 bg-linear-to-r from-white to-white/60 bg-clip-text text-transparent">Forgot password?</h2>
