...
import { User, Mail, AtSign, Save, Loader2, Sparkles, Shield } from 'lucide-react';
      ...
      <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-white/5 to-transparent border border-white/10 p-8">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
          <div className="relative group">
            <div className="w-24 h-24 md:w-32 md:h-32 rounded-3xl bg-linear-to-tr from-brand to-brand-secondary p-[3px] shadow-2xl shadow-brand/20 transition-transform group-hover:scale-105 duration-300">
              <div className="w-full h-full rounded-[21px] bg-bg-dark-1 flex items-center justify-center overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-neutral-500 uppercase tracking-widest ml-1 flex items-center gap-1.5">
                Email Address
                <span className="text-[10px] lowercase font-normal italic opacity-60">(Cannot be changed)</span>
              </label>
      ...
      <div className="p-6 rounded-3xl bg-red-500/5 border border-red-500/10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-left">
              ...
              <p className="text-xs text-neutral-500 mt-1 max-w-sm">
                  Think your account has been compromised? Change your password or enable two-factor authentication.
              </p>
          </div>
