      ...
      <div className="hidden lg:flex w-5/12 bg-bg-dark-1 border-r border-white/5 relative flex-col p-12 justify-between overflow-hidden h-full">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <h2 className="text-4xl font-bold mb-6 text-white tracking-tight leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-linear-to-r from-brand to-brand-secondary">
              team's best work.
            </span>
          </h2>
          <p className="text-lg text-neutral-400 leading-relaxed mb-10">
            Establish your organization to manage dedicated workspaces, members,
            and billing in one centralized hub.
          </p>
              ...
              {[
                {
                  ...
                  desc: "Manage subscriptions in one place",
                },
                {
                  title: "Role-Based Access",
                  desc: "Granular permissions for every member",
                },
                {
                  title: "Unified Audit Logs",
                  desc: "Track activity across all workspaces",
                },
              ].map((item, i) => (
        ...
        <div className="w-full max-w-lg space-y-10 relative z-10">
          <div className="lg:hidden text-center mb-10">
            ...
            <p className="text-neutral-400 mt-2">
              Get started by setting up your organization profile.
            </p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="group space-y-2">
                <div className="flex items-end justify-between">
                  ...
                  <span className="text-[10px] px-2 py-0.5 rounded-full"></span>
                </div>
