...
import { MoreVertical, UserMinus, Shield, ShieldCheck } from "lucide-react";
  ...
  return (
    <>
      <button
        ...
        className={cn(
          "p-2 text-neutral-500 hover:text-white hover:bg-white/10 rounded-lg transition-all outline-none",
          isOpen
