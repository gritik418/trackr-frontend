...
export function DashboardHeader() {
  ...
  // Extract crude breadcrumb from pathname for demo
  // e.g. /dashboard/marketing/tasks -> Marketing / Tasks
  ...
  return (
    <header className="h-[72px] flex items-center px-6 gap-4 sticky top-0 z-30 transition-all duration-200 bg-dashboard-header-bg/80 backdrop-blur-md border-b border-dashboard-border">
      ...
      <div className="flex items-center gap-2 text-sm">
         ...
         <span className="text-dashboard-item-text font-medium capitalize">{workspace}</span>
         <span className="text-dashboard-item-text/50">/</span>
         <span className="text-dashboard-item-text-active font-medium capitalize">{page}</span>
      </div>
      ...
      <div className="ml-auto flex items-center gap-4">
         ...
         <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-dashboard-item-bg border border-dashboard-border text-sm text-dashboard-item-text hover:border-dashboard-border-hover hover:text-dashboard-item-text-active transition-all w-64 cursor-text group">
            <Search size={14} className="group-hover:text-dashboard-item-text-active transition-colors" />
            <span>Search...</span>
            <span className="ml-auto text-[10px] font-medium text-dashboard-item-text px-1.5 py-0.5 rounded border border-dashboard-border">CTRL K</span>
         </div>
